...
public class OxScoreSaveMgr : MonoBehaviour
{
    //싱글턴 인스턴스 선언
    public static OxScoreSaveMgr instance = null;
    ...
    //점수저장을 위한 코루틴 함수
    public IEnumerator SaveScore(string room_num, int game_num, string stu_num, int answ)
    {
